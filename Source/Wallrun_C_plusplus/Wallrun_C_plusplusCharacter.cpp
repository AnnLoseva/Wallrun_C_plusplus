...
void AWallrun_C_plusplusCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AWallrun_C_plusplusCharacter::OnResetVR);
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AWallrun_C_plusplusProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void AWallrun_C_plusplusCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AWallrun_C_plusplusCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AWallrun_C_plusplusCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool AWallrun_C_plusplusCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AWallrun_C_plusplusCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AWallrun_C_plusplusCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AWallrun_C_plusplusCharacter::TouchUpdate);
		return true;
	}
